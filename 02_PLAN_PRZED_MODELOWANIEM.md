...
**Założenie robocze zespołu (20.09.2026):** przyjmujemy, że wyniki NEURO pochodzą z hospitalizacji, w trakcie której tętniaka rozpoznano i leczono, a nie z okresu przed rozpoznaniem. Przemawia za tym rozkład badań — u 48,9% pacjentów NEURO z wieloma rekordami wszystkie mieszczą się w 30 dniach. Konsekwencja jest interpretacyjna: model rozpoznaje profil pacjenta hospitalizowanego z rozpoznanym tętniakiem, a nie profil ryzyka osoby niezdiagnozowanej, i tak musi być opisany w raporcie. Założenie czeka na potwierdzenie — patrz `4-pu-setup/PYTANIA_DO_PROWADZACEGO.md`.
